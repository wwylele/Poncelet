...
We shall also verify a property of $\mathrm{next}$ involving tangent points:
\begin{lemma}
    $\mathrm{next}$ maps an input to itself if and only if the input vertex is a tangent point of 
    the two circles.
\end{lemma}
\begin{proof}
    TODO
