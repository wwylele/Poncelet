...
\begin{definition}\label{elliptic}\lean{elliptic}\leanok
    $E$ is an affine cubic curve defined by
    \[
...
separate elliptic and singular cases for most parts. However, this will exclude the singular point from the 
bijection we are going to construct, which we will discuss later.
